'use strict';
// copied from Rhys' https://github.com/wheresrhys/directly,
// * with a small fix in the run() fn,
// * ability to specify a delay per promiser
...
function delayPromisers(promisers, delayMillis){
...
module.exports = function SmartConstructor (concurrence, funcs, delayMillis=0) {
	if (delayMillis > 0) {
		funcs = delayPromisers( funcs, delayMillis );
	}
